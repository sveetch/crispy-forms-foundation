"""
Basic Django settings for sample project.
...
SECRET_KEY = '@*vj@#rv=n*6bw+1_4e$5qpi8trb(5!wfn0l(5ub@0x$k#6rfm'
...
NOTE:
    ...
    * Every things below are needed settings for crispy-forms-foundation;
